...
import ReceiptSettingsPage from './features/profile/ReceiptSettingsPage';
        ...
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute />}>
            <Route element={<Layout />}>
              ...
              {/* Write-only routes. WriteRoute shows "Muda wa matumizi
                  umeisha" instead of the form once the licence has lapsed;
                  read-only routes below are left untouched. */}
              <Route path="select-congregant" element={
                <WriteRoute><SelectCongregant /></WriteRoute>
              } />
              ...
              <Route path="churches" element={
                <WriteRoute><ManageChurches /></WriteRoute>
              } />
              <Route path="manage-mhazini" element={
                <WriteRoute><ManageMhaziniPage /></WriteRoute>
              } />
              <Route path="receipt-settings" element={
                <WriteRoute><ReceiptSettingsPage /></WriteRoute>
              } />
